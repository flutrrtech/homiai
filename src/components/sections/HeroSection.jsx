    ...
    <>
        ...
        <div className="flex items-center justify-between w-[90%] m-auto gap-7">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6">
              Homi.ai transforms how startups, small businesses, and enterprises
              create marketing content. From social media posts to blogs, our
              AI-powered tool makes it seamless, fast, and effective.
            </p>
            <button
              onClick={() => navigate("/payment")}
              className="bg-blue-900 text-white text-lg font-semibold py-3 px-6 rounded-md hover:bg-blue-800 transition-all"
            >
              Try for Free Today →
            </button>
          </div>
      ...
      <div className="w-full px-16 mt-6 lg:mt-4 bg-gray-100">
        <div className="flex px-2 py-6 flex-wrap justify-between items-center gap-6 py-4 border-t border-gray-200">
          {[flutrr, google, facebook, youtube, pinterest].map(
            (brand, index) => (
              <img
                key={index}
                src={brand}
